...
figure(2); clf; % chooses the figure to display
...
[ax,h1,h2] = plotyy(DN(I),p(I),DN(I),speedJJ(I)); % plotyy allows for plotting time series with different y-axes on the same x-axis
